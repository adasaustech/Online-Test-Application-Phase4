...
export class QuizService {
  ...
  getAll() {
    return [
      {
        id: 'data/angular.json',
        name: 'Angular',
        description:
          "Let's Play Angular quiz that will help you clear the concepts and will prepare you for interviews. This is a basic level quiz and contains 10 Questions.",
